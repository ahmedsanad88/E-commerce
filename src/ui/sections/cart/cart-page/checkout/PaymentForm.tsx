    ...
    <div>
      ...
      <div className="mt-8">
        {selectedPayment === 'amazon pay' && (
          <p className="p-4 font-semibold text-[#171520]">
            Currently, The payment method is not available.
          </p>
        )}
        ...
        {selectedPayment === 'credit/debit card' && <CreditCard />}
        {selectedPayment === 'upi' && (
          <div className="rounded-md border-2 border-solid border-[#1B4B66] p-2">
